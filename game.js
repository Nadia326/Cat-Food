...
function startCreatingallfood() {
	stopCreatingallfood(); 
	spawnInterval = setInterval(function(){spawnFood(spawnAmount)},spawnTime)
}
...
Food.prototype.draw = function() {
	ctxfood.drawImage(products, this.srcX, this.srcY, this.width,this.height,
...
function clearCtxFood() {
	ctxfood.clearRect(0, 0, gameWidth, gameHeight);
}
